...
- `首尾帧练习/`：首尾帧练习素材
  - `提示词.txt`：首尾帧练习提示词
  - `首尾帧素材/`：首尾帧图片（`首帧.png` `尾帧.jpg`），用于 AI 视频首尾帧生成练习
...
### 2026-09-22
- `aigc-getting-started/` 重命名：汽车视频→汽车运镜视频、首尾帧→首尾帧练习（提示词.txt 并入首尾帧练习/）
- `aigc-getting-started/` 新增首尾帧练习素材：`首尾帧/`（首帧.png、尾帧.jpg）+ `提示词.txt`
