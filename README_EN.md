...
> AI Data Analysis Case Studies · Power & Renewables / Coal / Shipping / Finance + AI Getting-Started
> Author: Douyin (TikTok CN) channel "小王工作笔记" (ID: 163277992)

## Overview

This repository is a collection of **methodology / thinking notes** for AI-assisted data analysis. Raw data and final output charts are not included, so the workflows can be reused and shared easily.
...
└── ai-getting-started/        # AI getting-started
...
- Only methodology / thinking notes are kept here; raw data, output charts, videos, papers and assets are excluded.
- Repo name `xiaowang-gongzuo-biji` matches the author's Douyin channel "小王工作笔记".
